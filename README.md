...
- **Usability**: Incorporates both hardware and software for a seamless user experience. Has a built-in Li-Po (Li-Ion) battery charger, and can be charged and programmed via USB-C. Indication available as well.
